...
//        fiAPI.unaryBinaryOperator();
    ...
    public void consumer() {
        ...
        biCon.accept("Dublin", "Patna");
        biCon.accept("India Mah.", "Pune");
        System.out.println(mapCapitalCities);// {India Mah Pune}
        ...
        // hington D.CIndia Mah Pune. is the capital of: USA
    }
    ...
    public void function() {
        ...
        System.out.println("Function: " + fn2.apply("Mithlesh"));// 6
        ...
        System.out.println("BiFunction: " + biFn.apply("Kumar", "Wipro"));// 18

        BiFunction<String, String, String> biFn2   = (s1, s2) -> s1.concat(s2);
        System.out.println("BiFunction: " + biFn2.apply("Kumar ", "Wipro"));// William Shakespeare
    }
    public void unaryBinaryOperator() {
        ...
        System.out.println("UnaryOperator: " + unaryOp.apply("Mithlesh"));// My name is Sean
        ...
        System.out.println("BinaryOperator: " + binaryOp.apply("Kumar ", "Wipro"));// William Shakespeare
    }
}
